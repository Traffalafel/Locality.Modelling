$heights_feature_dir_path = $args[0]
$code_dir = ".."

$script_path = Join-Path $code_dir "heights" "aggregate_heights.py"

$1x1_heights_path = Join-Path $heights_feature_dir_path "1x1"
...
Get-ChildItem $1x1_heights_path -Filter "*.tif" | ForEach-Object {
    ...
    $file_out_path = Join-Path $heights_feature_dir_path "2x2" $file_name_tif
    ...
    python $script_path $file_name $heights_feature_dir_path
